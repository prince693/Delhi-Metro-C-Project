...
int main(){
	...
	int count=0;
//	count+=set_graph(graph,metro,37,count,yellow_line);
//	count+=set_graph(graph,metro,21,count,red_line);
//	count+=set_graph(graph,metro,51,count,blue_line);
//	count+=set_graph(graph,metro,6,count,orange_line);
//	count+=set_graph(graph,metro,21,count,green_line);
//	count+=set_graph(graph,metro,11,count,rapid_line);
//	count+=set_graph(graph,metro,34,count,voilet_line);
//	count+=set_graph(graph,metro,25,count,magenta_line);
//	count+=set_graph(graph,metro,38,count,pink_line);
//	count+=set_graph(graph,metro,8,count,blue_line2);
//	count+=set_graph(graph,metro,3,count,green_line2);
//	count+=set_graph(graph,metro,22,count,aqua_line);
//
//	set_weight(graph,metro,37,count,yellow_line,yl);
//	set_weight(graph,metro,21,count,red_line,rl);
//	set_weight(graph,metro,51,count,blue_line,bl);
//	set_weight(graph,metro,6,count,orange_line,ol);
//	set_weight(graph,metro,21,count,green_line,gl);
//	set_weight(graph,metro,11,count,rapid_line,rapl);
//	set_weight(graph,metro,34,count,voilet_line,vl);
//	set_weight(graph,metro,25,count,magenta_line,ml);
//	set_weight(graph,metro,38,count,pink_line,pl);
//	set_weight(graph,metro,8,count,blue_line2,bl2);
//	set_weight(graph,metro,3,count,green_line2,gl2);
//	set_weight(graph,metro,22,count,aqua_line,al);
...
//}
//
//void set_weight(float graph[V][V],map<string,int> metro, int x,string arr[],float *non){
//	for(int i=0;i<x-1;i++){
//  		int m=metro[arr[i]];
//		int n=metro[arr[i+1]];
//		graph[m][n]=non[i+1];
